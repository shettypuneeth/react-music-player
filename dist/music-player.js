...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsMusicPlayer = __webpack_require__(/*! ./components/music-player */ 157);
	
	var _componentsMusicPlayer2 = _interopRequireDefault(_componentsMusicPlayer);
	
	_react2['default'].render(_react2['default'].createElement(_componentsMusicPlayer2['default'], null), document.querySelector('.music-player-component'));
...
/* 157 */
/*!****************************************!*\
  !*** ./src/components/music-player.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _player = __webpack_require__(/*! ./player */ 158);
	...
	var MusicPlayer = (function (_React$Component) {
		...
		function MusicPlayer(props) {
			...
			_get(Object.getPrototypeOf(MusicPlayer.prototype), 'constructor', this).call(this, props);
		}
		...
		_createClass(MusicPlayer, [{
			...
			value: function render() {
				...
				return React.createElement(
					'div',
					{ className: 'mp-music-player' },
					React.createElement(
						CSSTransitionGroup,
						{ transitionName: 'my-player', transitionAppear: true, transitionAppearTimeout: 500, component: 'div' },
						React.createElement(_player2['default'], { key: '1',
							songs: songs })
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddons = __webpack_require__(/*! react/addons */ 159);
	
	var _reactAddons2 = _interopRequireDefault(_reactAddons);
	
	var _cover = __webpack_require__(/*! ./cover */ 177);
	
	var _cover2 = _interopRequireDefault(_cover);
	
	var _controls = __webpack_require__(/*! ./controls */ 179);
	
	var _controls2 = _interopRequireDefault(_controls);
	
	var _audio = __webpack_require__(/*! ./audio */ 181);
	...
	var Player = (function (_React$Component) {
		...
		_createClass(Player, [{
			...
			value: function componentDidMount() {
				...
				var _ref = _reactAddons2['default'].findDOMNode(this.refs.audioPlayer);
				this.player = _ref !== null ? _ref.querySelector('audio') : null;
				if (this.player) this._bindEvents();
			}
		}, {
			key: 'componentDidUnmount',
			value: function componentDidUnmount() {
				if (this.player) this._unbindEvents();
			}
		}, {
			key: '_bindEvents',
			...
			value: function _timeUpdate() {
				if (!this._isLoading()) {
					var completed = this._percentCompleted();
					this.setState({
			...
			key: '_percentCompleted',
			value: function _percentCompleted() {
			...
			key: '_goToSong',
			value: function _goToSong(index) {
			...
			key: '_updateStateEventHandler',
			value: function _updateStateEventHandler(e) {
				var state = undefined;
			...
			key: '_updateAudioPlayerState',
			value: function _updateAudioPlayerState(state) {
				this.setState({
	  ...
	  */
			...
			value: function render() {
				return _reactAddons2['default'].createElement(
					'section',
					{ className: 'mp-player' },
					_reactAddons2['default'].createElement(_cover2['default'], { key: this.state.song.id, imageUri: this.state.song.image, altText: this.state.song.album, isErrored: this.state.isErrored }),
					_reactAddons2['default'].createElement(_controls2['default'], { track: this.state.song,
					...
					_reactAddons2['default'].createElement(_audio2['default'], { ref: 'audioPlayer', sources: this.state.song.srcs, loadSource: this._load.bind(this) })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cx = __webpack_require__(/*! ./cx */ 174);
	var cloneWithProps = __webpack_require__(/*! ./cloneWithProps */ 168);
	var update = __webpack_require__(/*! ./update */ 175);
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(/*! ./ReactTestUtils */ 176);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(__webpack_require__(/*! ./ReactTransitionGroup */ 166));
	var ReactCSSTransitionGroupChild = React.createFactory(__webpack_require__(/*! ./ReactCSSTransitionGroupChild */ 171));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(/*! ./ReactElement */ 11);
	var ReactPropTransferer = __webpack_require__(/*! ./ReactPropTransferer */ 169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(/*! ./Object.assign */ 13);
	var emptyFunction = __webpack_require__(/*! ./emptyFunction */ 16);
	var joinClasses = __webpack_require__(/*! ./joinClasses */ 170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSCore = __webpack_require__(/*! ./CSSCore */ 172);
	var ReactTransitionEvents = __webpack_require__(/*! ./ReactTransitionEvents */ 173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _classnames = __webpack_require__(/*! classnames */ 178);
	...
	var Cover = (function (_React$Component) {
		...
		_createClass(Cover, [{
			...
			key: 'render',
			value: function render() {
				var classes = (0, _classnames2['default'])('mp-cover', {
				...
				return _reactAddons2['default'].createElement(
					...
					_reactAddons2['default'].createElement(
						'div',
						{ className: 'mp-cover__albumart' },
						_reactAddons2['default'].createElement('img', { src: this.props.imageUri, alt: this.props.altText })
					),
					_reactAddons2['default'].createElement(
						'span',
						{ className: 'mp-cover__banner' },
						'Now playing'
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _progressBar = __webpack_require__(/*! ./progressBar */ 180);
	...
	var Controls = (function (_React$Component) {
		...
		_createClass(Controls, [{
			...
			value: function render() {
				...
				var playButtonClass = (0, _classnames2['default'])('mp-control__button fa', {
				...
				return _reactAddons2['default'].createElement(
					...
					_reactAddons2['default'].createElement(
						'div',
						{ className: 'mp-control__meta' },
						_reactAddons2['default'].createElement(
							'span',
							{ className: 'mp-control__song_name' },
							track.name
						),
						_reactAddons2['default'].createElement(
							'span',
							{ className: 'mp-control__filler' },
							'by'
						),
						_reactAddons2['default'].createElement(
							'span',
							{ className: 'mp-control__song_artist' },
							track.artist
						)
					),
					_reactAddons2['default'].createElement(_progressBar2['default'], { isLoading: this.props.isLoading, percentComplete: this.props.percentComplete }),
					_reactAddons2['default'].createElement(
						'div',
						{ className: 'mp-control__actions' },
						_reactAddons2['default'].createElement('button', { className: 'mp-control__button small fa fa-backward icon-backward', onClick: this.props.prevSong.bind(this) }),
						_reactAddons2['default'].createElement('button', { className: playButtonClass, onClick: this.props.togglePlayPause.bind(this) }),
						_reactAddons2['default'].createElement('button', { className: 'mp-control__button small fa fa-forward icon-forward', onClick: this.props.nextSong.bind(this) })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Progressbar = (function (_React$Component) {
		...
		_createClass(Progressbar, [{
			key: 'render',
			value: function render() {
				var classes = (0, _classnames2['default'])('mp-progress', {
				...
				return _reactAddons2['default'].createElement(
					'span',
					{ className: classes },
					_reactAddons2['default'].createElement('span', { className: 'mp-progress__bar', style: progressStyle })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AudioElement = (function (_React$Component) {
		_inherits(AudioElement, _React$Component);
	
		function AudioElement() {
			_classCallCheck(this, AudioElement);
	
			_get(Object.getPrototypeOf(AudioElement.prototype), 'constructor', this).apply(this, arguments);
		}
	
		_createClass(AudioElement, [{
			key: 'shouldComponentUpdate',
			value: function shouldComponentUpdate(nextProps, nexState) {
				return !(0, _utilsShallowEqual2['default'])(this.props.sources, nextProps.sources);
			}
		}, {
				...
				return _reactAddons2['default'].createElement(
					...
					_reactAddons2['default'].createElement(
						...
						sources.map(function (s) {
							return _reactAddons2['default'].createElement('source', { key: s.src, src: s.src, type: s.type });
						})
					)
				);
			}
...
/***/ function(module, exports) {
	...
	/* 
	* Borrowed from https://github.com/gaearon/react-pure-render.git
	* All credit belongs to gaeron [https://github.com/gaearon]
	*/
	'use strict';
